...
Node *parseComparison(Token *tokens, int *pos);  // < > == etc
Node *parseTerm(Token *tokens, int *pos);        // + - (binary)
Node *parseFactor(Token *tokens, int *pos);      // * / %
Node *parseUnary(Token *tokens, int *pos);       // + - ! (unary)
Node *parsePrimary(Token *tokens, int *pos);     // Literals, Vars, Consts, (), func()
...
// --- Forward Declarations for Compiler/VM functions ---
